...
Acao: Use a tool ficticia `AccountStatusTool` para consultar o status da conta
Observacao:
- accountStatus: "LOCKED"
- failedLoginAttempts: 5

Passo 2 - Pensamento: Verifique se houve redefinicao recente de senha
Acao: Use a tool ficticia `PasswordResetHistoryTool` para consultar os eventos de redefinicao
Observacao:
...
Acao: Use a tool ficticia `UnlockAccountTool` para desbloquear a conta
Observacao:
